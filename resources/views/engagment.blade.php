                    ...
                    <div
                        ...
                        <div class="animateme" data-when="span" data-from="0" data-to="0.75" data-opacity="0.1"
                            ...
                            <h2 class="main_title has_titlebig ">
                                <span><strong>ENGAGMENT</strong></span>
                            </h2>
                            <!--/ Main Big Title -->
                        </div>
                        <!--/ Captions animateme wrapper -->
        ...
        <div class="col-md-6  order-1 order-md-2">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-10 blurb mb-5 mb-md-0">
                    ...
                    <p>A good business with your customer increases when you know who ARE your customers. Uzzar
                        will asisst you keep the records of your customer details with ease and retrive them
                        whenever you are in need to.</p>
                </div>
            </div>
        </div>
    </div>
    <div class="row align-items-center contents mt-50">
        <div class="col-md-6">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-10 blurb mb-5 mb-md-0">
                    <h2>Messaging</h2>
                    <p>Message your customers on various issues concerning your business directly from the
                        application through the customer records in the system. Send orders, reminders, notices
                        and make sure that you keep your customer intact.</p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
    ...
    <div class="row align-items-center contents mt-50">
        ...
        <div class="col-md-6 order-1 order-md-2">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-10 blurb mb-5 mb-md-0">
                    <h2>Gift Cards</h2>
                    <p>Do you want to reward your loyal customers? Uzzar will help you tell who is your loyal
                        customer among the many that you have and gift them accordingly by genereting gift cards
                        disccount couppn that they may use on their next purchase.</p>
                </div>
            </div>
        </div>
    </div>

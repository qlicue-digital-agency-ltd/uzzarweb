                    ...
                    <div class="col-sm-6 col-md-6 col-lg-3 mb-30">
                        ...
                        <div class="clearfix">
                            ...
                            <ul class="social-icons sc--clean clearfix">
                                ...
                                <li><a href="#" target="_self" class="fab fa-youtube" title="Youtube"></a></li>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <p class="fs-xsmall text-center-xs">
                            © 2019 All rights reserved. Product by <a href="http://www.qlicue.co.tz"><span
                                        style="text-decoration: underline">Qlicue</span></a>.
                        </p>
                    </div>
                    <div class="col-sm-6">
